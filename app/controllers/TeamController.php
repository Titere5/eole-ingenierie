...
=======
      var_dump("ui");die;
        ...
        public function AddMemberAction(){
            ...
            $form = new MemberForm;
            $imageFolder = 'public/image_membre/';
            ...
            if ($this->request->isPost()) {
                ...
                if ($this->request->hasFiles()) {
                    ...
                    foreach ($files as $file) {
                        ...
                        $file->moveTo('../public/image_membre/' . $file->getName());
                        $membre->photo = $file->getName();
                    }
                }
                $membre->nom = $name;
                ...
                //$membre->image_path = $imageFolder . $membre;
                //var_dump($image_produit->image_path);die;
                // $membre->dateAjout_Produit = new Phalcon\Db\RawValue('now()');
                if ($membre->save() == false) {
                    //var_dump($produits->getMessages());die;
                    foreach ($membre->getMessages() as $message) {
                        $this->flash->error((string) $message);
                    }
                } else {
                    $this->flash->success('Le membre a été correctement ajouté.');
                    // die;
                    //$form->clear();
                }
